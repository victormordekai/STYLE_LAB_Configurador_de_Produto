...
- `library_forms/`: padrões, formas orgânicas, geometria pontilhada e biblioteca representativa de escudos.
- `library_modeling/`: catálogo MOLDE/SKU, famílias de produto e `mrp-data.json`.
- inspector dinâmico de tamanho/fonte.
- exportação SVG com estilos computados inline para evitar o problema de formas pretas quando o arquivo é aberto fora da aplicação.
- modelagem V3 com família básica/raglan e gola redonda/V/Polo.
